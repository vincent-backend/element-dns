<template>
    <div class="domain-container">
        <div class="domin-manage">条件转发列表</div>
        <div class="header-container">
            <div class="header-left">
                <el-button type="primary" @click="dialogFormVisible = true">添加条件转发</el-button>
                <el-dialog title="添加条件转发" :visible.sync="dialogFormVisible" class="dialog">
                    <el-form :model="addForm" :rules="addDominRules">
                        <el-form-item label="域名：" label-width="65px" prop="domain">
                            <el-input v-model="addForm.domain" autocomplete="off" placeholder="如 wddns.net"></el-input>
                        </el-form-item>
                        <el-form-item label="IP：" label-width="65px" prop="ip">
                            <el-input v-model="addForm.ip" autocomplete="off"
                                placeholder="DNS服务器的IP地址，如 114.114.114.114，多个用逗号分隔"></el-input>
                        </el-form-item>
                ...
                <span class="info">可指定域名使用指定的DNS服务器来解析</span>
            </div>
        ...
        <el-table size="small" id="out-table" :header-cell-style="fun" stripe ref="multipleTable" :data="domainList"
            ...
            <el-table-column prop="ip" label="IP" width="360"></el-table-column>
            <el-table-column prop="state" show-overflow-tooltip width="160">
                    ...
                    <div>
                        <el-dropdown class="more" placement="bottom">
                            ...
                            <el-dropdown-menu slot="dropdown" class="drop">
                                <div class="more-list">
                                    <el-dropdown-item
                                        @click.native="delDomain(scope.row)">删除&nbsp;&nbsp;&nbsp;&nbsp;</el-dropdown-item>
                                    <span class="shu">|</span>
