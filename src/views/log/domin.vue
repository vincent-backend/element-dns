<template>
  <div class>
    ...
    <el-table size="small" :header-cell-style="fun" stripe ref="multipleTable" :data="optList" tooltip-effect="dark"
      ...
      <el-table-column prop="uid" show-overflow-tooltip label="用户" width="150">
        <template #default="scope">
          <el-button type="text" size="mini" icon="el-icon-user" v-if="uid == -1"
            @click="selectUid(scope.row.uid)"></el-button><el-button type="text" v-if="uid >= 0" size="mini"
            icon="el-icon-user-solid" @click="selectUid(-1)"></el-button>{{ scope.row.uname }}
        </template>
      </el-table-column>
      <!--<el-table-column prop="ot" show-overflow-tooltip label="类型" width="120"></el-table-column>-->
      <el-table-column prop="ip" show-overflow-tooltip label="ip" width="200"></el-table-column>
      <el-table-column prop="msg" label="内容" show-overflow-tooltip></el-table-column>
      <el-table-column prop="rtime" label="时间" width="200"></el-table-column>
    </el-table>
